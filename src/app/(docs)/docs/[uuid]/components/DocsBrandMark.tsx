 ...
 * 文档站品牌图标 —— 3D 线框立方体
 *
 * 来自线上 docs 工程的 `DocHeader.tsx`（直拷，无改动）：三层立方体叠加，
 * 蓝色 + 白色（暗色模式切到 slate-800）形成线框效果。`font-nycd`（线上
 * 给标签用的手写体）web 工程里没有对应字体，所以标签那行换 web 默认 sans。
 *
 * 单一用途：详情页头部那行图标。只在 `/docs/[uuid]/page.tsx` 路径上展示。
 */
export default function DocsBrandMark({
  width = 64,
  height = 54,
}: {
  width?: number | string;
  ...
  return (
    ...
    >
      ...
      <path
        className="fill-white dark:fill-slate-800"
        d="M0.168 19.451c-.11.198-.168.42-.168.647v11.837c0 .465.242.896.639 1.138l10.666 6.518c.21.128.45.196.695.196V26.683L0.168 19.451Z"
      />
      <path
        className="fill-blue-600"
